...
set(LIBXML2_INCLUDE_DIR    /opt/toolchains/aarch64-linux-musl-cross/include/libxml2)
set(LIBXML2_LIBRARY_DIR    /opt/toolchains/aarch64-linux-musl-cross/lib)

find_library(LIBXML2_LIBRARY NAMES xml2 HINTS ${LIBXML2_LIBRARY_DIR} NO_DEFAULT_PATH)
find_program(LIBXML2_XMLCATALOG_EXECUTABLE NAMES xmlcatalog HINTS /opt/toolchains/aarch64-linux-musl-cross/bin NO_DEFAULT_PATH)
find_program(LIBXML2_XMLLINT_EXECUTABLE NAMES xmllint HINTS /opt/toolchains/aarch64-linux-musl-cross/bin NO_DEFAULT_PATH)
